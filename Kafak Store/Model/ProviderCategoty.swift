...
struct Api_ProviderCat : Codable {
    let result : [Res_ProviderCat]?
    let message : String?
    let status : String?
    ...
    init(from decoder: Decoder) throws {
        ...
        result = try values.decodeIfPresent([Res_ProviderCat].self, forKey: .result)
...
struct Res_ProviderCat : Codable {
    let id : String?
    let store_id : String?
